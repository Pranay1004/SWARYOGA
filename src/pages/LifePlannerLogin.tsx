...
const LifePlannerLogin: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Life Planner Login</h1>
          ...
          >
            {isSubmitting ? (
              ...
              <>
                ...
                <span>Login to Life Planner</span>
              </>
            )}
          </button>
        </form>
...
export default LifePlannerLogin;